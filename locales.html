...
<head>
	<title>HD Trademark cliente</title>
...
<body>
	...
	<div id="background-container">
		<img alt="" src="upload/banners/slide2.jpg">
	</div>
	<!-- End Background -->
		...
		<div id="content">
			...
			<div class="section-content page-banner portfolio-page-banner">
				<div>
					...
					<p>HD Trademark: Nos lo solicitaron, lo hicimos</p>
				</div>
			</div>
			...
			<div class="single-project">
				...
				<br><div class="project-block">
					<div class="flexslider">
						<ul class="slides">
							<li>
								<img alt="" src="upload/portfolio/remodelacion1.jpg" />
							</li>
							<li>
								<img alt="" src="upload/portfolio/remodelacion2.jpg" />
							</li>
							<li>
								<img alt="" src="upload/portfolio/remodelacion3.jpg" />
							</li>
						</ul>
					</div>
					<div class="single-project-content">
<h1>Implementación de Locales Comerciales</h1>
<h3>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. </h3>
						<p><span>Proin quis elit vel ligula rutrum bibendum. Aenean et orci hendrerit, consectetur nulla eu, viverra magna. In et ipsum. Fusce gravida quam non velit ornare bibendum. Etiam sit amet diam arcu. </span></p>
